...
(Optional) Drop an MP3 file named music.mp3 into the same folder for background music.
...
Detection Rate: 1/70 (False Positive)

📜 License
This project is licensed under the Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0).

Non-Commercial: You may not use this software or the source code for commercial purposes or resale.

Attribution: You must give appropriate credit to MonoDev if you share or adapt this work.

Created by MonoDev Studio.
